...
const PROGMEM uint8_t rhythm1[1] = {0};
const PROGMEM uint8_t rhythm2[2] = {0, 8};
const PROGMEM uint8_t rhythm3[3] = {0, 5, 10};
const PROGMEM uint8_t rhythm4[4] = {0, 4, 8, 12};
const PROGMEM uint8_t rhythm5[5] = {0, 3, 6, 9, 12};
const PROGMEM uint8_t rhythm6[6] = {0, 3, 5, 8, 11, 13};
const PROGMEM uint8_t rhythm7[7] = {0, 3, 5, 7, 10, 12, 14};
const PROGMEM uint8_t rhythm8[8] = {0, 2, 4, 6, 8, 10, 12, 14};

bool isInArr(const uint8_t *arr, uint8_t len, uint8_t val)
{
  for (uint8_t i = 0; i < len; ++i)
  {
    if (pgm_read_byte_near(arr + i) == val)
      return true;
  }
  return false;
}
